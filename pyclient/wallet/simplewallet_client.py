...
class SimpleWalletClient(object):
    ...
    def add(self, deviceID, productID, senderAcc, courierAcc, receiverAcc, PUlat, PUlong,maxTemp, minTemp, maxHumi, minHumi, delilat, delilong, deliFunds):
        try:
            retValue = self._wrap_and_send("add", deviceID, productID, senderAcc, courierAcc, receiverAcc, PUlat, PUlong,
                                           maxTemp, minTemp, maxHumi, minHumi, delilat, delilong, deliFunds)
        except Exception:
            raise Exception('Encountered an error during add')
        return retValue
